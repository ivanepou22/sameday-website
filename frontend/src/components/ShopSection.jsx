...
import {
  serviceSelector,
  getServices,
} from "../feautures/services/serviceSlice";
...
const ShopSection = () => {
  ...
  const filterServicesWellness = services?.filter(
    (service) => service.category === "Wellness"
  );
  const filterServicesCOVID = services?.filter(
    (service) => service.category === "COVID"
  );
  let filterServicesByNiche = filterServicesWellness;

  //filter services by niche
  if (niche !== "all") {
    filterServicesByNiche = filterServicesWellness.filter(
      (service) => service.niche[0] === niche
    );
  }
        ...
        <div className="container">
          <div className="row justify-content-center margin-top-0">
            <div className="packages-niche">
              ...
              <button
                className={`btn btn-outline-primary btn-sm btn-block ${
                  mainTab === "Covid" ? "active" : ""
                }`}
                onClick={() => setMainTab("Covid")}
              >
                Covid 19 Packages
              </button>
              <button
                className={`btn btn-outline-primary btn-sm btn-block ${
                  mainTab === "Radiology" ? "active" : ""
                }`}
            ...
            <div className="row justify-content-center margin-top-0">
              <div className="packages-niche">
                ...
                <button
                  ...
                  onClick={() => setNiche("Women")}
                >
                  Women
                </button>
                <button
                  className={`btn btn-outline-primary btn-sm btn-block ${
                    niche === "Children" ? "active" : ""
                  }`}
                  onClick={() => setNiche("Children")}
                >
                  Children
                </button>
                <button
                  ...
                  onClick={() => setNiche("Men")}
                >
                  Men
                </button>
                <button
                  className={`btn btn-outline-primary btn-sm btn-block ${
                    niche === "General" ? "active" : ""
                  }`}
