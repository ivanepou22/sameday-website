        ...
        <div className="container">
          ...
          <div className="menu-extras">
            <div className="menu-item">
              <Link
                className={
                  showMobileMenu ? "navbar-toggle open" : "navbar-toggle"
                }
                id="isToggle"
                to="#/"
          ...
          <ul className="dropdowns list-inline mb-0">
            ...
            <li className="list-inline-item mb-0 ms-1">
              <Link to="/shopping-cart">
                <button
                  type="button"
                  className={`btn p-0 position-relative border-none`}
                >
            ...
            {user ? (
              ...
              <li className="list-inline-item">
                <Link
                  to="/login"
                  className="btn btn-login-register btn-orange  padding-left"
                >
                  <AiOutlineUser />{" "}
          ...
          <div
            id="navigation"
            className={showMobileMenu ? "display-block" : "display-none"}
          >
            <ul className="navigation-menu nav-left nav-light">
              ...
              <li className="has-submenu parent-menu-item">
                ...
                <ul
                  className={setShowAboutSubmenu ? "submenu open" : "submenu"}
                >
                  <li>
              ...
              {user ? (
                ...
                <li>
                  <Link
                    to="/login?redirect=/create-appointment"
