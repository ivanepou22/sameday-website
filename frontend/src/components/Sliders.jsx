                  ...
                  <div className="ms-lg-4 slider-wl-content">
                    <div className="section-title">
                      ...
                      <p className="text-muted para-desc mb-0 font-size-15 color-black">
                        One of the unique things that sets us apart from others
                        is that we focus on wellness and preventive care for our
                        patients -we have a highly skilled team of health care
                        professionals including nurses and doctors that will
                        evaluate the results of our patient's lab studies and
                        give you advice accordingly.
                      </p>
                    </div>

                    <div className="mt-4">
                      <Link to="/wellness-center" className="btn btn-orange">
                ...
                <div className="col-lg-12 col-md-6 mt-4 mt-lg-0 pt- pt-lg-0">
                  <div className="ms-lg-4">
                    <div className="section-title">
                      ...
                      <p className="text-muted para-desc mb-0 font-size-15 color-black">
                        We have a comprehensive radiology department that
                        includes x-rays ultrasound and ECG‘s to further give a
                        more in-depth analysis as to what is going on with the
                        patient. X-ray imaging is the fastest and easiest way
                        for us to view and assess broken bones, joints or other
                        injuries to a patient.
                      </p>
                    </div>

                    <div className="mt-4">
                      <Link to="/radiology-services" className="btn btn-orange">
                        Read More <RiArrowRightSLine />
                      </Link>
                    </div>
                  </div>
                ...
                <div className="col-lg-12 col-md-6 mt-4 mt-lg-0 pt- pt-lg-0">
                  <div className="ms-lg-4">
                    <div className="section-title">
                      ...
                      <p className="text-muted para-desc mb-0 font-size-15 color-black">
                        We stand for excellence in delivering high quality,
                        safe, effective and efficient medical laboratory
                        diagnostic services. With a focus on excellence, we
                        employ the latest technologies in offering top notch
                        medical diagnostic services and medical laboratory
                        services.
                      </p>
                    </div>
                ...
                <div className="col-lg-12 col-md-6 mt-4 mt-lg-0 pt- pt-lg-0">
                  <div className="ms-lg-4">
                    <div className="section-title">
                      ...
                      <p className="text-muted para-desc mb-0 font-size-15 color-black">
                        With our expertise, professionalism, state-of-the-art
                        and highly sterile laboratories for your test needs,
                        highly skilled, trained and experienced staff, we aim to
                        be the leading voice of transformation and improvement
                        of health care in Uganda.
                      </p>
                    </div>

                    <div className="mt-4">
                      <Link to="/covid-testing" className="btn btn-orange">
                        Read More <RiArrowRightSLine />
                      </Link>
                    </div>
                  </div>
