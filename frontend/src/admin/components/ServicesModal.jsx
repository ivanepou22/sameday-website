...
const ServicesModal = (props) => {
  ...
  const handleImageChange = (e) => {
    ...
    const ps = new Promise((resolve, reject) => {
      ...
      data.append("upload_preset", "emxwgppl");
  ...
  const selectFn = (e) => {
    e.forEach((el) => {
      subItems?.includes(el.value)
        ? console.log("yes")
        : setSubItems((prev) => [...prev, el.value]);
    });
  };
        ...
        >
          <div className="modal-content">
            ...
            <div className="modal-body p-3 pt-4">
              {service && service.id && (
                <div className="alert alert-success">Service created successfully</div>
              )}
              ...
              <form onSubmit={handleSubmit}>
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-6">
                    <div className="mb-3">
                      <label className="form-label">
                        Sub Items <span className="text-danger">*</span>
                      </label>
                      <Select
                        name="subItems"
