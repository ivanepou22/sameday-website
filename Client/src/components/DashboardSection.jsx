              ...
              >
                <li className="nav-item">
                  <Link
                    ...
                    className={`nav-link rounded ${dashboard ? "active" : ""}`}
                    id="dashboard"
                    data-bs-toggle="pill"
                    href="#dash"
                    role="tab"
                  ...
                  >
                    <div className="text-start py-1 px-3">
                      <h6 className="mb-0">
                        <AiOutlineDashboard className="uil uil-list-ul h5 align-middle me-2 mb-0" />{" "}
                        Dashboard
                      </h6>
                    </div>
                  </Link>
                ...
                <li className="nav-item mt-2">
                  <Link
                    ...
                    className={`nav-link rounded ${showOrders ? "active" : ""}`}
                    id="order-history"
                    data-bs-toggle="pill"
                    href="#orders"
                    role="tab"
                  ...
                  >
                    <div className="text-start py-1 px-3">
                      <h6 className="mb-0">
                        <BsListTask className="uil uil-list-ul h5 align-middle me-2 mb-0"></BsListTask>{" "}
                        Orders
                      </h6>
                    </div>
                  </Link>
                ...
                <li className="nav-item mt-2">
                  <Link
                    ...
                    className={`nav-link rounded ${showAppointments ? "active" : ""}`}
                    id="order-history"
                    data-bs-toggle="pill"
                    href="#orders"
                    role="tab"
                  ...
                  >
                    <div className="text-start py-1 px-3">
                      <h6 className="mb-0">
                        <AiOutlineCalendar className="uil uil-list-ul h5 align-middle me-2 mb-0"></AiOutlineCalendar>{" "}
                        Appointments
                      </h6>
                    </div>
                  </Link>
                ...
                <li className="nav-item mt-2">
                  <Link
                    ...
                    className={`nav-link rounded ${showVisits ? "active" : ""}`}
                    id="order-history"
                    data-bs-toggle="pill"
                    href="#orders"
                    role="tab"
                  ...
                  >
                    <div className="text-start py-1 px-3">
                      <h6 className="mb-0">
                        <RiFileUserLine className="uil uil-list-ul h5 align-middle me-2 mb-0"></RiFileUserLine>{" "}
                        Patient Visits
                      </h6>
                    </div>
                  </Link>
                ...
                <li className="nav-item mt-2">
                  <Link
                    ...
                    className={`nav-link rounded ${showAddress ? "active" : ""}`}
                    id="addresses"
                    data-bs-toggle="pill"
                    href="#address"
                    role="tab"
                  ...
                  >
                    <div className="text-start py-1 px-3">
                      <h6 className="mb-0">
                        <HiOutlineLocationMarker className="uil uil-map-marker h5 align-middle me-2 mb-0"></HiOutlineLocationMarker>{" "}
                        Addresses
                      </h6>
                    </div>
                  </Link>
                ...
                <li className="nav-item mt-2">
                  <Link
                    ...
                    className={`nav-link rounded ${showProfile ? "active" : ""}`}
                    id="account-details"
                    data-bs-toggle="pill"
                    href="#account"
                    role="tab"
                  ...
                  >
                    <div className="text-start py-1 px-3">
                      <h6 className="mb-0">
                        <FiUser className="uil uil-user h5 align-middle me-2 mb-0"></FiUser> Account
                        Details
                      </h6>
                    </div>
                  </Link>
              ...
              <div className="tab-content" id="pills-tabContent">
                ...
                >
                  <p className="text-muted">
                    Hello <span className="text-dark">{user?.name}</span> (not{" "}
                    <span className="text-dark fw-bold">{user?.name}</span>?{" "}
                    <Link to="/logout" className="text-danger fw-bold">
                      Log out
                    </Link>
                    )
                  </p>
                  ...
                  <p className="text-muted mb-0">
                    ...
                    <Link to="#/" onClick={handleOrders} className="text-danger fw-bold">
                      recent orders
                    </Link>
                    , manage your{" "}
                    <Link to="#/" onClick={handleProfile} className="text-danger fw-bold">
                        ...
                        {orders.map((ord) => (
                          <tr key={ord.id}>
                            ...
                            <td className="p-3">
                              ...
                              <span className="text-muted"> for {ord.orderItems.length} Items</span>
                            </td>
                            <td className="p-3">
                              <Link
                                to="#"
                ...
                >
                  <div className="table-responsive bg-white shadow rounded">
                    <table className="table mb-0 table-center table-nowrap">
                      <thead>
                        <tr>
                          <th className="border-bottom p-3 white-space-wrap-none" scope="col">
                            Appoint no.
                          </th>
                          <th className="border-bottom p-3 white-space-wrap-none" scope="col">
                            Date
                          ...
                          <table className="table table-center bg-white mb-0">
                            <thead>
                              <tr>
                                ...
                                <th className="border-bottom p-3 white-space-wrap-none">
                                  Patient Email
                                </th>
                                ...
                                <th
                                  className="border-bottom p-3 white-space-wrap-none"
                            ...
                            <tbody>
                              {filteredVisits?.map((visit, index) => (
                                <tr key={visit.id}>
                                  ...
                                  <td className="p-3 white-space-wrap-none">
                                    {moment(visit.next_visit_14_days).format("DD-MM-YYYY")}
                                  </td>
                                  <td className="p-3 white-space-wrap-none">
                                    {moment(visit.next_visit_90_days).format("DD-MM-YYYY")}
                                  </td>
                                  <td className="p-3 white-space-wrap-none">{visit.address}</td>
                                  <td className="p-3 white-space-wrap-none">
                                    {visit.consultation_results}
                                  </td>
