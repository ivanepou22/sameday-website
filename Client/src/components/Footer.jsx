                                ...
                                <div className="col-md-4 col-12 mt-4 mt-sm-0 pt-1 pt-sm-0">
                                    ...
                                    <ul className="list-unstyled footer-list mt-4 font-size-15">
                                        <li className="d-flex align-items-center">
                                            <BiEnvelope />
                                            <Link to="mailto:info@samedaylabwork.com" className="text-foot ms-2"> info@samedaylabwork.com </Link>
                                        </li>
                                        <li className="d-flex align-items-center">
                                            <FiPhone />
                                            <Link to="tel:+256708850000" className="text-foot ms-2"> +256708850000 | +256775108946</Link>
                                        </li>
                                        <li className="d-flex align-items-center">
                        ...
                        <div className="row align-items-center font-size-15">
                            <div className="col-sm-6">
                                <div className="text-sm-start text-center">
                                    <p className="mb-0">
                                        © SameDay Laboratories {year}. All Rights Reserved.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="col-sm-6 mt-4 mt-sm-0">
                                <ul
                                    className="list-unstyled footer-list text-sm-end text-center mb-0"
                                >
                                    <li className="list-inline-item">
                                        <Link to="/" className="text-foot me-2">Terms</Link>
                                    </li>
                                    <li className="list-inline-item">
                                        <Link to="/l" className="text-foot me-2">Privacy</Link>
                                    </li>
                                    <li className="list-inline-item">
                                        <Link to="/about" className="text-foot me-2">About</Link>
                                    </li>
                                    <li className="list-inline-item">
                                        <Link to="/contact" className="text-foot me-2">Contact</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
