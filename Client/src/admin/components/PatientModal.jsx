                ...
                <div className="modal-dialog modal-lg modal-dialog-centered" onClick={e => { e.stopPropagation(); }} >
                    <div className="modal-content">
                        <div className="modal-header border-bottom p-3">
                            <h5 className="modal-title" id="exampleModalLabel">Add a Patient</h5>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <input name="f_name" id="f_name" type="text" className="form-control" placeholder="Your First Name :" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 col-md-6">
                                        <div className="mb-3">
                                            <label className="form-label">Last Name <span className="text-danger">*</span></label>
                                            <input name="f_name" id="f_name" type="text" className="form-control" placeholder="Your Last Name :" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 col-md-6">
                                        <div className="mb-3">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="float-right">
                                            <button type="submit" className="btn btn-primary">Submit a Patient</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
